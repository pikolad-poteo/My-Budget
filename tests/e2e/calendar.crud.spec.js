// End-to-end CRUD tests for calendar events.
// The flow creates, edits and deletes a temporary event through the browser to validate the full route/view/database path.
